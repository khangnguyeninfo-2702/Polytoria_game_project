...
A fast-paced, high-intensity zombie survival game built from the ground up on **Polytoria**. This project is a spiritual successor and total revision of a previous Roblox title, refined for shorter, more explosive gameplay sessions without losing the nail-biting tension of a final stand.
...
| :--- | :--- | :--- |
| **The Artificer** | Tactical / Trap-based | Uses Gears and automated defenses. |
| **The Tank** | Frontline / Defensive | High HP and built-in knockback resistance. |
...
## 📝 Devlogs
You can follow the detailed progress of this project in the `/docs` folder or on my [Devlog Site](YOUR_LINK_HERE).
